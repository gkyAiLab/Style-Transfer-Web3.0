...
import matting.utils as utils
import matting.transformer as transformer
# import video
...
class matting_model:
    def preload_init(self):
        ...
        print(self.sytle_model)
        style_transform_path='./matting/transforms/'+self.sytle_model+ '.pth'
    ...
    def matting_step(self,image,input,style_type='None'):
            ...
            if(input=='2'):
                if(style_type=='None'):
                    ...
                    if(self.change_style_model=='True'):
            ...
            if(input=='3'):
                if(style_type=='None'):
                    self.sytle_model='mosaic' #matting+no choose style=mosaic
                if(self.change_style_model):
                        matting_model.preload_init(self) # style reload
